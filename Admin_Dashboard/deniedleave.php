            ...
            <div class="card">
			  ...
			  <a href="#"><button type="button" class="btn btn-primary" onclick="window.print();">
                ...
                <h3 class="card-title" style="float: right;">
				 <?php echo htmlspecialchars($lang['ddl']);?> </h3>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th> <?php echo htmlspecialchars($lang['db']);?> </th>
					<th> <?php echo htmlspecialchars($lang['ddate']);?> </th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php
					  ...
					  $dbs = new database();
					  $db=$dbs->connection();
                      $result = mysqli_query($db,"SELECT l.*,e.employee_firstname,e.employee_middlename,lt.Type_of_Name FROM leavedetails l JOIN employee_table e ON l.EmpId=e.employee_id JOIN type_of_leave lt on l.TypesLeaveId=lt.LeaveId WHERE LeaveStatus='Denied'");

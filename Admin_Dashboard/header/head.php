...
?>
<?php include('include/access/connector.php'); ?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($lang['hro']);?> </title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                      ...
                      <?php                             
								    ...
								    $pandingleave2 = mysqli_query($phdb,"select count(LeaveStatus) as pleave from leavedetails where LeaveStatus='pending'");
                                     $tpandingleave2 = mysqli_fetch_assoc($pandingleave2);
                                    ?>  


                                <span class="badge" style="background-color:#F79663;"><i class="fa fa-inbox"></i><?php echo(isset($tpandingleave2['pleave']))?$tpandingleave2['pleave']:"";?></span>
					</a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="Admin_Dashboard.php" class="brand-link" style="background-color:#528EB5;">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p>
                                    <?php echo htmlspecialchars($lang['employee']);?>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="Add_employee.php" class="nav-link">
                                        ...
                                        <p><?php echo htmlspecialchars($lang['me']);?></p>
                                    </a>
                                </li>
								<li class="nav-item">
                                    <a href="attendanceview.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['ad']);?></p>
                                    </a>
                                </li>
								<li class="nav-item">
                                    <a href="validateattendance.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['va']);?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p>
                                   <?php echo htmlspecialchars($lang['ml']);?>
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
							 <li class="nav-item">
                                    <a href="addleavetype.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['alt']);?></p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="pendingleave.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
										<p><?php echo htmlspecialchars($lang['pl']);?></p> <?php                             
								...
								<li class="nav-item">
                                    <a href="acceptedleaverequest.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['accl']);?></p>
                                    </a>
                                </li>
								<li class="nav-item">
                                    <a href="deniedleave.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['dl']);?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                       <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="adminaddnotice.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p><?php echo htmlspecialchars($lang['an']);?></p>
                                    </a>
                                </li>
                            </ul>
                        </li> 

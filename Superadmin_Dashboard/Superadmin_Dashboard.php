                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo htmlspecialchars($lang['mc']);?></span>
                            ...
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-success elevation-1"><i class="fa fa-code-branch"></i></span>
                                 <?php                             
                                    ...
                                    ?> 
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo htmlspecialchars($lang['mb']);?></span>
                            ...
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-warning elevation-1"><i class="fa fa-universal-access"></i></span>
                                 <?php                             
                                    ...
                                    ?> 
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo htmlspecialchars($lang['ma']);?></span>

...
?><link rel="stylesheet" href="../../css/popup_style.css">
    ...
    $startd = date('Y-m-d', strtotime($date));
       ...
       $sql = $phdb->query("UPDATE `corporate_table`  SET `corporate_name` = '$corporate_name', `date_created` ='$startd' WHERE corporate_id = '$corporate_id'")  or die (mysqli_error($phdb));
       if($sql == TRUE){
       	      ?>
  ...
  <div class="popup__content">
    ...
    <p>Corporate Updated Successfully</p>
    <p>
